...
use PurchasedAt\Validation\Verify;
...
class CheckoutItem
{
    ...
    {
        Preconditions::checkDictionary($name, 'name', ['\\PurchasedAt\\Validation\\Preconditions','checkIso2Language'], ['\\PurchasedAt\\Validation\\Preconditions','checkStringNonEmpty']);
