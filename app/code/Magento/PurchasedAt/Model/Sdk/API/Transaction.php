...
class Transaction
{
    ...
    private $id;
    /**
     * @see \Magento\PurchasedAt\Model\Sdk\Purchase\Transaction::externalId
    ...
    private $project;
    /** @var \Magento\PurchasedAt\Model\Sdk\API\Item Item handled in the transaction. (only one of item and checkout are non-null) */
    private $item;
    /** @var \Magento\PurchasedAt\Model\Sdk\API\Checkout Checkout handled in the transaction. (only one of item and checkout are non-null) */
    private $checkout;
    /** @var string Type of the transaction, one of "item", "checkout" */
    private $type;
    /** @var \Magento\PurchasedAt\Model\Sdk\API\Customer Customer information of the transaction. */
    private $customer;
    /** @var \Magento\PurchasedAt\Model\Sdk\API\Price Pricing information of the transaction */
    private $price;
