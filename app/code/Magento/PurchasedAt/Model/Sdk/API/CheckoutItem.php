...
class CheckoutItem
{
    ...
    private $externalId;
    /** @var \Magento\PurchasedAt\Model\Sdk\API\Price Price of a single item. */
    private $price;
    /** @var \Magento\PurchasedAt\Model\Sdk\API\Price Calculated total price of a items (count * price). */
    private $total;
