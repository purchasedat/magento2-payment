...
class Test
{
    ...
    public function build()
    {
        return array(
            ...
            'revision_mode' => $this->revisionMode,
        );
    }
    ...
    {
        Preconditions::checkIso2Country($country, 'country');
    ...
    {
        Preconditions::checkArray($languages, 'languages', ['\\Magento\PurchasedAt\Model\Sdk\\Validation\\Preconditions','checkIso2Language']);
    ...
    public function setRevisionMode($revisionMode)
    {
        ...
        if ($revisionMode && !in_array($revisionMode, $validValues)) {
            throw new \InvalidArgumentException(
                $revisionMode .
                ' is not a valid revision mode for testing. Please use one of ' .
                implode(', ', $validValues) . '.');
        }
