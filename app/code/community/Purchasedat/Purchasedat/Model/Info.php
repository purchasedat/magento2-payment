...
/**
 * Purchasedat_Purchasedat_Model_Info
 */
class Purchasedat_Purchasedat_Model_Info
{
    /**
    ...
    {
        // Collect purchasedat-specific info
	...
	protected function _getLabel( $key )
    {
        ...
        {
            case 'payment_status':
                $label = Mage::helper( 'purchasedat' )->__( 'Payment Status' ); break;
            case 'm_payment_id':
                $label = Mage::helper( 'purchasedat' )->__( 'Payment ID' ); break;
            case 'pb_payment_id':
                $label = Mage::helper( 'purchasedat' )->__( 'purchasedat Payment ID' ); break;
            case 'email_address':
                $label = Mage::helper( 'purchasedat' )->__( 'Email Address' ); break;
            default:
                $label = ''; break;
        }
